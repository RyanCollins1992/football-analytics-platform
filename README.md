...
This README documents **Phases 1-5 (foundation through the analytics engine)**. Later phases add their own sections here as they land — see the phase list at the bottom.
